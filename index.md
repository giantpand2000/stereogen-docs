...
The repository includes three sample images for learning and testing:

- [`depth-map.png`]({{ site.baseurl }}/test-assets/depth-map.png) — depth input
- [`texture.png`]({{ site.baseurl }}/test-assets/texture.png) — repeating texture
- [`material-map.png`]({{ site.baseurl }}/test-assets/material-map.png) — mapped-texture input
